	...
	"elements": [
		{
			...
			"opacity": 100,
			"angle": 0,
			"x": -145.75006103515625,
			"y": -476.41246795654297,
			"strokeColor": "#1e1e1e",
		...
		},
		{
			...
			"text": "你可以按 [ 和 ] 来逐个显示和隐藏",
			"rawText": "你可以按 [ 和 ] 来逐个显示和隐藏",
			"textAlign": "left",
			"verticalAlign": "top",
			"containerId": null,
		...
		},
		{
			...
			"angle": 0,
			"x": -650.6300109863282,
			"y": -473.84911804199214,
			"strokeColor": "#1e1e1e",
			"backgroundColor": "transparent",
			"width": 1298.5599853515625,
			"height": 623.3599975585937,
			"seed": 1462616002,
			"groupIds": [],
			"frameId": null,
			"roundness": null,
